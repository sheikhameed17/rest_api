package com.sheik.restapi.Day6.model;
...
public class ChildrenModel {
	...
	public ChildrenModel(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
			String address) {
		super();
		this.babyId = babyId;
